...
You can download the complete bike CAD as a `.step` file from <a href="/2024fa-gyrocycle/step/complete-bicycle.step" download>this link</a>.

::: details Complete CAD Preview
<StlViewer stlUrl="/2024fa-gyrocycle/stl/complete-bicycle.stl" />
:::
...
We designed a stand to put the bike on when it is not balancing. You can download its CAD as a `.step` file from <a href="/2024fa-gyrocycle/step/stand-without-bicycle.step" download>this link</a>.

...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern:
        "https://github.com/epfl-cs358/2024fa-gyrocycle/edit/main/docs/:path",
        ...
        items: [
          ...
          { text: "Bill of Materials (BoM)", link: "/guide/bom" },
          {
            ...
            items: [
              ...
              {
                text: "Manufacturing the Flywheel Shaft",
                link: "/guide/manufacturing-shaft.md",
              },
            ],
          },
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/epfl-cs358/2024fa-gyrocycle",
      },
    ],
  },
});

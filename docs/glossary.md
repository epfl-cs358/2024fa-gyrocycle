...
In the context of GyroCycle, _child wheels_ refer to the safety part of the bike that prevents the bicycle from completely falling on its side. Instead, it stops the fall at a reasonable angle, hence its name.

<img src="/images/child-wheels.jpg" width="300" />

## Flywheel

GyroCycle uses a _flywheel_ to balance. A flywheel is a wheel that rotates to resist changes in motion and counter some other force, in our case the tilt of the bicycle.

When we say flywheel we refer to the big flywheel component at the back of the bicycle.

<StlViewer stlUrl="/2024fa-gyrocycle/stl/to-be-printed/flywheel.stl" />
